...
![Initial state – no labels created](screenshots/scenario-1/01-initial-state.png)
...
![Label 1 – Custom permissions employee](screenshots/scenario-1/02-label1-permissions-employee.png)
...
![Label 1 – Custom permissions internal](screenshots/scenario-1/03-label1-permissions-internal.png)

**Step 3 — Access Control final state**
Both recipients assigned. Expiry: Never. Offline access: 7 days:

![Label 1 – Access Control final](screenshots/scenario-1/04-label1-access-control-final.png)

**Step 4 — Review & Finish**

![Label 1 – Review & Finish](screenshots/scenario-1/05-label1-review-finish.png)

**Step 5 — Created**

![Label 1 – Created](screenshots/scenario-1/06-label1-created.png)
...
![Label 2 – Access Control final](screenshots/scenario-1/08-label2-access-control-final.png)

**Step 2 — Review & Finish**

![Label 2 – Review & Finish](screenshots/scenario-1/09-label2-review-finish.png)
